      ...
      <Head>
        ...
        <main className={styles.main}>
            ...
            <div class="px-8 md:px-16 lg:px-32 py-10 md:py-20 text-center">
                <div class="bg-gray-500 text-white rounded-md p-10">
                    <h3 class="text-3xl">Contact Us</h3>
                    <p class="my-4">Send us a message, enquiry or any suggesstion. We'll get back to you as early as possible.
                    </p>
            ...
            <div class="px-8 md:px-16 lg:px-32 py-10 md:py-20 bg-gray-100">
                <div class="grid grid-cols-4 gap-8">
                    <div class="col-span-4 sm:col-span-2 lg:col-span-1">
                        <h4 class="text-3xl font-semibold">Black Tigers</h4>
                        <p class="my-6 mr-4">
                            We are an indigenous Nigerian Security compan with Corporate Affairs Commission (CAC) registration(RC1408582) 
                            and licensed with Federal Ministry of Interrior through the Nigerian Civil Defense Corps and other security agencies.                 
                        </p>
                    ...
                    <div class="col-span-2 sm:col-span-2 lg:col-span-1">
                        ...
                        <p class="my-6"><a href="#">About Us</a></p>
                        <p class="my-6"><a href="#">Contact</a></p>
                    </div>
                    <div class="col-span-2 sm:col-span-2 lg:col-span-1">
                        <h4 class="text-3xl font-semibold">Services</h4>
                        <p class="my-4"><a href="#">Physical Security</a></p>
                        <p class="my-4"><a href="#">Protective Security</a></p>
                        <p class="my-4"><a href="#">Security Management</a></p>
                        <p class="my-4"><a href="#">Private Investigators</a></p>
                        <p class="my-4"><a href="#">Security Education</a></p>
                        <p class="my-4"><a href="#">Electronic Security Gadgets</a></p>
                    </div>
                    <div class="col-span-2 sm:col-span-2 lg:col-span-1">
                        <h4 class="text-3xl font-semibold">Contact</h4>
                        <p class="my-6"><a href="tel:+234">+234 (0) 0701 234 5678</a></p>
                        <p class="my-6"><a href="mailto:info@example.com">info@blacktigers.com</a></p>
                        <p class="my-6">Kaduna, Nigeria</p>
                    </div>
                </div>
            </div>
        </main>
